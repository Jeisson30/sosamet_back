/**
 * Instala SP_VALIDAR_DOCUMENTO_NUMERO_CONTRATO en BD local.
 * Uso: node scripts/install-validar-documento-contrato.js
 */
...
async function main() {
  ...
  await conn.query('DROP PROCEDURE IF EXISTS SP_VALIDAR_DOCUMENTO_NUMERO_CONTRATO');
  await conn.query(`
...
END`);
  ...
  console.log('OK  SP_VALIDAR_DOCUMENTO_NUMERO_CONTRATO instalado');
  await conn.end();
}
