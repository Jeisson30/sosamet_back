-- ============================================================
-- PRODUCCIÓN: mantenimiento Órdenes de Trabajo
-- Ejecutar en Workbench sobre la BD sosamet (o prod equivalente)
--
-- 1) SP_ACTUALIZAR_ORDEN_TRABAJO
-- 2) SP_ANULAR_ORDEN_TRABAJO   (ot_estado = 3)
-- 3) SP_ELIMINAR_ORDEN_TRABAJO (borra detalle + cabecera; no toca actas)
-- ============================================================
